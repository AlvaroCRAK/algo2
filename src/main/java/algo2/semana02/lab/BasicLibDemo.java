...
public class BasicLibDemo {
    ...
    void procesarCirculo() {
        ...
        System.out.format("El área del círculo con radio %.2f es %.2f%n", radio, area);
    ...
    void procesarCadena() {
        ...
        if ("*#.-/".contains(cad3)) {
            ...
            if (pos >= 0) {
                ...
                System.out.format("Con la subcadena('%s') reemplazada por '%s' sería '%s'%n", cad2, cad3, cad1.replace(cad2, cad3));
            } else {
    ...
    void procesarFechas() {
        System.out.println("Funcionalidad de fechas pendiente.");
    }
